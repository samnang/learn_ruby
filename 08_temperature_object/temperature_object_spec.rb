...
describe Temperature do
  ...
  describe "utility class methods" do
    it "in degrees celsius by calling #ftoc" do
      Temperature.ftoc(50).in_celsius.should == 50
    end

    it "in degrees fahrenheit by calling #ctof" do
      Temperature.ctof(50).in_fahrenheit.should == 50
    end
  end
